...
Un module Alertmanager, référencé par Prometheus via \code{rule\_files}, complète cette chaîne de collecte avec des règles d'alerte concrètes portant sur l'indisponibilité de l'API, un taux d'erreurs HTTP 5xx élevé, une latence p95 dégradée et une consommation mémoire excessive du service \code{backend-api}.
