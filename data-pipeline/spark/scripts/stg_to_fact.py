...
def stg_to_fact_flight(job_id):
    ...
    cursor.execute("""
        INSERT INTO fact_flight (
            flight_sk, journey_sk,
            departure_airport_code, departure_airport_time,
            arrival_airport_code, arrival_airport_time,
            duration, flight_number, layover_duration, total_journey_duration,
            price, airline, airline_logo, type, is_best, pos,
            is_delayed, updated_at
        )
        SELECT
            flight_sk, journey_sk,
            departure_airport_code, departure_airport_time,
